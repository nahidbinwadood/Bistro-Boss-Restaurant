    ...
    >
      <div className="bg-[#151515B3] h-full text-white">
        ...
        <div className="container mx-auto flex flex-col md:flex-row gap-12">
          ...
          <div className="w-1/2 flex flex-col gap-4 justify-center font-inter">
            ...
            <div>
              <button className=" px-8 py-4 rounded-xl font-inter outline-none border-2 border-t-0 border-r-0 border-l-0 border-b-white text-xl hover:bg-[#1F2937] hover:text-white transition hover:border-b-[#1F2937]">
                Read More
              </button>
            </div>
          </div>
