      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
        <div className="card font-inter  bg-base-100 shadow-xl pb-8">
          ...
          <div className=" pt-6 text-center space-y-4">
            ...
            <p className="text-lg w-3/4 mx-auto">Lettuce, Eggs, Parmesan Cheese, Chicken Breast Fillets.</p>
            <div className="">
              <button className="text-[#BB8506] px-8 py-4 rounded-xl outline-none border-2 border-t-0 border-r-0 border-l-0 border-b-[#BB8506] text-xl hover:bg-[#1F2937] transition hover:border-b-[#1F2937]">Add To Cart</button>
            </div>
          </div>
        </div>
        <div className="card font-inter  bg-base-100 shadow-xl pb-8">
